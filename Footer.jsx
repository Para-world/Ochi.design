...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 p-20 font-["Founders_Grotesk_X_Condensed"]'>
        <div className='w-1/2 h-full flex flex-col justify-between '>
       <div className='heading'>
       <h1 className='text-[9vw]  font-semibold uppercase leading-none -mb-9'>Eye-</h1>
       <h1 className='text-[9vw] font-semibold uppercase leading-none -mb-9'>Opening</h1>
       </div>
